...
const Footer = () => {
  return (
    <>
      <footer className="bg-custom-green bottom-0 left-0 right-0">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 px-6 md:px-24">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a href="#" className="text-gray-500 hover:text-sunset-orange">
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
                  xmlns="#"
              ...
              <a
                href="#"
                className="text-gray-500 hover:text-sunset-orange ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
